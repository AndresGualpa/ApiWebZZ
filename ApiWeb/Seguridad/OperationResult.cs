...
namespace ApiWeb.Seguridad
{
    public class OperationResult<TResult>
    {
        ...
        {
            return new OperationResult<TResult> { Success = false, Message = "Hubo un problema inesperado. Espera un momento y vuelve a intentarlo. Comuniquece con el adminitrador del sistema. " };
        }
        public static OperationResult<TResult> CreateFailure(TResult result)
        {
            return new OperationResult<TResult> { Data = result, Success = false, Message = "Hubo un problema inesperado. Espera un momento y vuelve a intentarlo.. Comuniquece con el adminitrador del sistema." };
        }
